...
func (r Running) Calories() float64 {
	s := r.meanSpeed()
	return ((CaloriesMeanSpeedMultiplier*s + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * float64(r.Training.Duration.Hours()) * MinsInHour)
}
...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(w.Training.meanSpeed(), 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinsInHour)
}
